...
yyreduce:
  ...
  case 2:
#line 86 "lexer.y"
                         {node* root =makeTree1("CODE",(yyvsp[0].n)) ;printtree(root,0);}
#line 1587 "y.tab.c"
    break;
...
#line 1683 "y.tab.c"
  ...
  case 20:
#line 104 "lexer.y"
                                         {node* t1=makeTree2("id's",makenode((yyvsp[-4].valueToShow)),(yyvsp[-3].n));node* type1 =makeTree1("type",(yyvsp[-1].n));(yyval.n)=makeTree2("var declare",t1,type1);}
#line 1689 "y.tab.c"
    break;
...
#line 1803 "y.tab.c"
  ...
  case 42:
#line 123 "lexer.y"
                              {(yyval.n)=makeTree1((yyvsp[-2].n),makenode((yyvsp[0].valueToShow)));}
#line 1809 "y.tab.c"
    break;
